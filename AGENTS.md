...
- When `HERDR_ENV=1`, ALWAYS split a dedicated sibling Herdr pane for each subagent before it starts. Preserve the controller's pane and working directory, keep focus unchanged, and use Herdr agent controls rather than the native Task tool.
