...
You SHOULD delegate each assessment to a separate subagent for independence. Subagents should return their findings as structured text. Do NOT output findings to the user yet.
